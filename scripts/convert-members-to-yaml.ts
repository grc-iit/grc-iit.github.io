...
members.forEach((member) => {
  ...
  if (!cleanMember.bio) {
    const bioTemplate = `${cleanMember.name} is a ${cleanMember.title} in the Department of Computer Science at the Illinois Institute of Technology and a member of the Gnosis Research Center.`;
