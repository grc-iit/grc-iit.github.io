...
#### Agent Configuration Performance: IOR Deployment

We compared eight agent-model combinations deploying the IOR parallel I/O benchmark across five distinct prompts to assess performance and correctness tradeoffs.
...
**Tool Call Success Rates** (5 prompts):
- **Claude Code + Sonnet 4**: ~**100%**
- **Gemini CLI + Gemini 2.5 Pro**: ~**100%**
- **OpenCode + Devstral**: **92.7%**
- **Cursor + GPT-5**: ~**92.8%**
- **Cursor + GPT-4o**: ~**91.8%**
- **OpenCode + Sonic**: ~**91.7%**

While tool success rates varied, all configurations eventually corrected mistakes and achieved correct IOR deployment. Notably, the OpenCode configuration using local Devstral model for execution maintained competitive success rates (92.7%) compared to large cloud-only models.
