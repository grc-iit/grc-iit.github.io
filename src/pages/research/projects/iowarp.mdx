...
The screenshot above demonstrates how researchers can use Warpio to interact with the **National Data Platform (NDP)**, automatically discovering, downloading, and preparing scientific datasets for analysis. In this example, an AI agent accesses EarthScope's seismological data repository, retrieves recent earthquake data (including GeoJSON metadata and CSV seismograph records), and prepares it for computational analysis—all through conversational commands rather than manual data management steps.
